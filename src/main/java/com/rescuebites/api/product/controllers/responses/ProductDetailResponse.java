...
@Schema(description = "Respuesta detallada del producto con información del comercio")
public record ProductDetailResponse(
        ...
        @Schema(description = "Ahorro en pesos")
        BigDecimal savings,

        @Schema(description = "Categoría del producto")
        ProductCategory category,

        @Schema(description = "Nombre legible de la categoría")
