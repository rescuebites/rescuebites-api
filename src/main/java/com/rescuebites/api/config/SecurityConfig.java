        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST,
                                                                "/api/v1/commerces/validate-registration")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.POST,
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/commerces/*/search")
                                                .hasRole("COMMERCE")
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/v1/commerces/*/search/suggestions")
                                                .hasRole("COMMERCE")

                                                // Reportes del comercio
                                                .requestMatchers(HttpMethod.GET, "/api/v1/commerces/*/reports/**")
                                                .hasRole("COMMERCE")
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/v1/public/**").permitAll()
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/v1/public/products/commerce/*/ordered-by-stock")
                                                .permitAll()
                                                .requestMatchers(HttpMethod.GET,
                                                                "/api/v1/public/products/commerce/*/expiring")
                                                .permitAll()
